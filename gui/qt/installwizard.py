...
from electrumcrown import Wallet, WalletStorage
from electrumcrown.util import UserCancelled, InvalidPassword
from electrumcrown.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET
...
MSG_GENERATING_WAIT = _("Electrum Crown is generating your addresses, please wait...")
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "Crown addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Electrum Crown wallet'))
    ...
    def init_network(self, network):
        message = _("Electrum Crown communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Electrum "
                  "Crown pick one at random.  However if you prefer feel free"
                  " to select a server manually.")
