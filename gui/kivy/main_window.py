...
import electrumcrown
from electrumcrown.bitcoin import TYPE_ADDRESS
from electrumcrown import WalletStorage, Wallet
from electrumcrown_gui.kivy.i18n import _
from electrumcrown.paymentrequest import InvoiceStore
from electrumcrown.util import profiler, InvalidPassword
from electrumcrown.plugins import run_hook
from electrumcrown.util import format_satoshis, format_satoshis_plain
from electrumcrown.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrumcrown_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrumcrown_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrumcrown_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrumcrown_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrumcrown_gui.kivy.uix.screens')
...
from electrumcrown.util import base_units
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'mCRW')
    ...
    def on_qr(self, data):
        from electrumcrown.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrumcrown.transaction import Transaction
        from electrumcrown.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrumcrown.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrumcrown_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrumcrown_gui.kivy.uix.qrcodewidget')
