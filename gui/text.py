...
from electrumcrown.util import format_satoshis, set_verbosity
from electrumcrown.bitcoin import is_address, COIN, TYPE_ADDRESS
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrumcrown.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
