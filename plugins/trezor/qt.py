...
from electrumcrown_gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                  OkButton, CloseButton)
from electrumcrown.i18n import _
from electrumcrown.plugins import hook
from electrumcrown.bitcoin import bh2u
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "{} device can spend your crowns.").format(plugin.device))
